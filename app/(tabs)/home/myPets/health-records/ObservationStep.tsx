...
import { Add01Icon, Cancel01Icon, PointingLeft01Icon } from "@hugeicons/core-free-icons";
...
export default function ObservationStep({ data, updateData }: ObservationStepProps) {
    ...
    const handleRemoveObservation = (index: number) => {
        const updatedObservations = observations.filter((_: string, i: number) => i !== index);
        updateData('observations', updatedObservations);
    };
                    ...
                    <View key={index} style={styles.observationItem}>
                         <View style={styles.observationLeft}>
                            <View style={styles.iconCircle}>
                                <HugeiconsIcon icon={PointingLeft01Icon} size={16} color={Colors.textSecondary} />
                            </View>
