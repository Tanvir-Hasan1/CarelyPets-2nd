...
export default function RecordDetailsStep({
  data,
  updateData,
}: RecordDetailsStepProps) {
  ...
  return (
    <View style={styles.container}>
      ...
      <CustomDatePicker
        ...
        initialDate={
          datePickerVisible === "date" ? data.date : data.nextDueDate
        }
      />
