...
const SERVICES = [
    { id: 'vet', name: 'Vet', icon: VetIcon, color: '#4DD0E1', bgColor: '#E0F7FA' },
    { id: 'grooming', name: 'Grooming', icon: GroomingIcon, color: '#4DB6AC', bgColor: '#E0F2F1' },
    { id: 'training', name: 'Training', icon: TrainingIcon, color: '#4FC3F7', bgColor: '#E1F5FE' },
    { id: 'walking', name: 'Walking', icon: WalkingIcon, color: '#81C784', bgColor: '#E8F5E9' },
];

const TIME_SLOTS = [
    '9:00 AM', '9:30 AM', '10:00 AM',
    '11:00 AM', '11:30 AM', '1:30 PM', '2:00 PM',
    '2:30 PM', '3:00 PM'
];
        ...
        <View style={styles.container}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.section}>
                    ...
                    <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.petsList}>
                        {pets.map((pet) => (
                            ...
                            >
                                <View style={[styles.petImageContainer, selectedPetId === pet.id && styles.selectedPetImage]}>
                                    {pet.image ? (
                                        <Image source={{ uri: pet.image }} style={styles.petImage} />
                                    ) : (
                                        <View style={[styles.petImage, { backgroundColor: '#EEE' }]} />
                                    )}
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.servicesGrid}>
                        {SERVICES.map((service) => (
                            ...
                            >
                                <View style={[styles.serviceIconContainer, { backgroundColor: service.bgColor }, selectedServiceId === service.id && styles.selectedServiceIcon]}>
                ...
                <View style={styles.section}>
                    ...
                    <Text style={[styles.sectionTitle, { marginTop: Spacing.lg }]}>Available Times</Text>
