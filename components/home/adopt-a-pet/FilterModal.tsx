...
const AVAILABILITY_OPTIONS = ["All", "Available", "Pending", "Adopted"];
...
export default function FilterModal({
    ...
    PanResponder.create({
      ...
      onPanResponderMove: (_, gestureState) => {
        ...
        if (newMin < currentFilters.ageRange[1]) {
          setFilters((prev) => ({
            ...prev,
            ageRange: [newMin, prev.ageRange[1]],
          }));
        }
      },
    }),
    ...
    PanResponder.create({
      ...
      onPanResponderMove: (_, gestureState) => {
        ...
        if (newMax > currentFilters.ageRange[0]) {
          setFilters((prev) => ({
            ...prev,
            ageRange: [prev.ageRange[0], newMax],
          }));
        }
      },
    }),
  ...
  const leftHandlePos =
    sliderWidth > 0
      ? (filters.ageRange[0] / 250) * (sliderWidth - sliderPadding * 2) +
        sliderPadding
      : sliderPadding;
  const rightHandlePos =
    sliderWidth > 0
      ? (filters.ageRange[1] / 250) * (sliderWidth - sliderPadding * 2) +
        sliderPadding
      : sliderPadding;
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.section}>
              ...
              <Text style={styles.searchingText}>
                "{filters.query || "Enter search term"}"
              </Text>
            </View>
              ...
              <View style={styles.chipRow}>
                {GENDER_OPTIONS.map((option) => (
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      setFilters((prev) => ({ ...prev, gender: option }))
                    }
                  >
                    <Text
                      style={[
            ...
            <View style={styles.section}>
              ...
              <View style={styles.sliderLabels}>
                <Text style={styles.sliderLabel}>
                  {filters.ageRange[0]} YEARS
                </Text>
                <Text style={styles.sliderLabel}>
                  {filters.ageRange[1]} YEARS
                </Text>
              </View>
            </View>
